...
async def list_shift_types(include_inactive: bool = Query(False), db: AsyncSession = Depends(get_db)):
    return await shift_type_service.list_shift_types(db, include_inactive)
